// Command roach-code-desktop is the Wails shell around the Roach Code kernel: a native
...
// a nested module (roach-code/desktop) so the CGO/WebKit desktop build never touches
...
import (
	...
	// cmd/roach-code does — boot.Build resolves providers/tools from these registries.
...
// mirroring cmd/roach-code/main.go. The auto-updater reads it (App.Version) to compare
