...
####
## Roach Code per-user NSIS installer.
##
...
####
!macro roach-code.writeUninstaller
...
!macro roach-code.deleteUninstaller
...
Section
    ...
    !insertmacro roach-code.writeUninstaller
SectionEnd
...
Section "uninstall"
    ...
    !insertmacro roach-code.deleteUninstaller
SectionEnd
