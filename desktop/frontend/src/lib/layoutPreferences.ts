...
const STORAGE_KEY = "roach-code.layoutPreferences.v1";

const LEGACY_SIZE_KEYS: Record<LayoutSizeKey, string[]> = {
  sidebarWidth: ["roach-code.sidebar.width"],
  workspacePanelWidth: ["roach-code.workspacePanel.width"],
  workspaceFileTreePanelWidth: [],
  workspaceTreeWidth: ["roach-code.workspaceTree.width"],
  composerHeight: ["roach-code.composerHeight"],
  drawerWidth: ["roach-code.drawer.width"],
  settingsDrawerWidth: ["roach-code.settingsDrawer.width"],
};
