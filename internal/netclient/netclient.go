// Package netclient builds HTTP clients that share Roach Code's user-facing proxy
...
// NewHTTPClient returns an HTTP client with Roach Code proxy settings applied.
