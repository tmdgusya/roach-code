...
var Chinese = Messages{
	...
	SlashHelp:          "命令：/compact · /new · /resume · /rewind · /tree · /branch · /switch · /todo · /verbose · /model（切换模型）· /effort · /theme · /mcp · /skill · /hooks · /jobs · /paste-image · /memory · /quit · /help · 以及 skills（/init、/explore …）",
