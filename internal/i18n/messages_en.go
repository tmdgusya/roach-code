...
var English = Messages{
	...
	SlashHelp:          "commands: /compact · /new · /resume · /rewind · /tree · /branch · /switch · /todo · /verbose · /model (switch model) · /effort · /theme · /mcp · /skill · /hooks · /jobs · /paste-image · /memory · /quit · /help · plus skills (/init, /explore, …)",
