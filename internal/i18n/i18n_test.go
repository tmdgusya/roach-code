...
// $LC_ALL / $ROACH_LANG. Unknown locales return "" so DetectLanguage falls
...
// TestDetectLanguagePriority verifies override beats env and that ROACH_LANG
...
func TestDetectLanguagePriority(t *testing.T) {
	...
	t.Setenv("ROACH_LANG", "en")
	if got := DetectLanguage(""); got != "en" {
		t.Errorf("ROACH_LANG=en overriding LANG=zh: got %q, want en", got)
	}
