...
func TestProviderConfigured(t *testing.T) {
	...
	cases := []struct {
		...
		{"key set", ProviderEntry{APIKeyEnv: "ROACH_TEST_KEY"}, true},
		{"key env empty", ProviderEntry{APIKeyEnv: "ROACH_TEST_EMPTY"}, false},
		{"key env unset", ProviderEntry{APIKeyEnv: "ROACH_TEST_MISSING"}, false},
