...
func EffortCapabilityForEntry(e *ProviderEntry) EffortCapability {
	...
	case isResponsesEntry(e):
		return EffortCapability{Supported: true, Levels: []string{"auto", "low", "medium", "high"}, Default: "medium"}
	default:
...
// isResponsesEntry reports whether the entry targets the OpenAI Responses API
// provider (registered under "openai-responses" and "codex").
func isResponsesEntry(e *ProviderEntry) bool {
	return e != nil && (e.Kind == "openai-responses" || e.Kind == "codex")
}
