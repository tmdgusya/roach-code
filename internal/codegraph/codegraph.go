...
// than shipped in the roach-code binary, which keeps installs small. Resolve finds
...
import (
	...
	"roach-code/internal/proc"
)

// BundleDirName is the directory, beside the roach-code executable, that the release
...
//  4. a bundle placed beside the roach-code executable (fallback for manual setups).
//
...
// bundled looks for the CodeGraph launcher unpacked beside the roach-code binary.
