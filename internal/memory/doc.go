// Package memory implements Roach Code's persistent memory. It mirrors Claude
// Code's two-layer model while honoring Roach Code's cache-first architecture:
//
//   - Hierarchical doc memory: ROACH-CODE.md / AGENTS.md files discovered from the
...
const (
	ScopeUser     Scope = "user"     // ~/.config/roach-code/ROACH-CODE.md
	ScopeAncestor Scope = "ancestor" // a ROACH-CODE.md above the project root
	ScopeProject  Scope = "project"  // ./ROACH-CODE.md (committed, shared)
	ScopeLocal    Scope = "local"    // ./ROACH-CODE.local.md (personal, git-ignored)
)

// docNames are the recognized memory filenames at each level, in load order.
// ROACH-CODE.md is ours; AGENTS.md and CLAUDE.md are the cross-tool conventions.
...
var docNames = []string{"ROACH-CODE.md", "AGENTS.md", "CLAUDE.md"}

// localNames are the personal, git-ignored overrides, highest precedence.
var localNames = []string{"ROACH-CODE.local.md", "AGENTS.local.md", "CLAUDE.local.md"}
...
// maxImportDepth bounds "@path" import recursion.
